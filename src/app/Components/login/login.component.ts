...
export class LoginComponent implements OnInit {
  ...
  CustomerLogin(regForm: any) {
    ...
    console.log(data);
    this.http.post('http://mobikart-alb-1432438635.us-east-1.elb.amazonaws.com/processLogin', data, { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) }).subscribe((res) => {

...
export class ConfirmationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.http.post('http://mobikart-alb-1432438635.us-east-1.elb.amazonaws.com/getOrderData', JSON.stringify({ customer: customer_id, puchase_time: time }), { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) }).subscribe((res) => {
      this.model = res
